...
<%
  String sessionType2 = (String) session.getAttribute("sessionType");
...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main style="margin:10px; padding: 7px">
            <h1 class="mt-4 white">Ürün Listesi</h1>
       ...
       while(rs.next()) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            if(rs.getInt(8)>0) {
                                            %>
                                            <span>Stokta Var  (<%=rs.getInt(8)%> Adet)
                                        ...
                                        %>
                                        <td>
                                            <a class="btn btn-danger" href="urunsil.jsp?id=<%=rs.getString(1)%>" >Sil</a>
                                        </td>
