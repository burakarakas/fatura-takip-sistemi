...
<html lang="en">
        ...
        <div id="layoutSidenav">
            ...
            <div id="layoutSidenav_content">
                <main style="margin:10px; padding: 7px">
                     <h1 class="mt-4 white">Fatura/Satış Listesi</h1>
    ...
    <div class="container-fluid px-4">
                        <div class="card mb-4">
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    <thead>
                                        <tr>
                                       <th>Ürünü Satın Alan Kişi Bilgileri</th>
                       ...
                       String SQL_QUERY = "SELECT * FROM fatura ";
                        ...
                        while(rs.next()) {
                            %>
                                       <tr>
                                         ...
                                         <a id="urundetaybuton-<%=rs.getString(1)%>" onclick="urundetaygoster(<%=rs.getString(1)%>)" class="btn btn-warning">Kişi Detay Gör</a>
                                            
                                         <div class="urundetay-<%=rs.getString(1)%> urundetaygoster">
                                                 <%
                       ...
                       String SQL_QUERY2 = "SELECT * FROM user where id="+rs.getString(2);
                       ...
                       rs2 = statementProduct2.executeQuery(SQL_QUERY2);
                                                while(rs2.next()) {
                                                %>
                                                <span> İsim : <%=rs2.getString(4)%></span>
                                                <br>
                                                <span> Telefon : <a href="tel:<%=rs2.getString(5)%>"><%=rs2.getString(5)%></a></span>
                                                <br>
                                                      <span> Email : <a href="mailto:<%=rs2.getString(2)%>"><%=rs2.getString(2)%></a></span>
...
$(document).ready(function (){
    $('.urundetaygoster').hide();
    
    
});
            function urundetaygoster(id){
                var dataid= id;
                if( $('.urundetay-'+id).is(":visible")==true){
